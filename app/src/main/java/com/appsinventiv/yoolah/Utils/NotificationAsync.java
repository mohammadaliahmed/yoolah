...
public class NotificationAsync extends AsyncTask<String, String, String> {
    ...
    public final static String AUTH_KEY_FCM_LIVE = "AAAAuzZTIoI:APA91bE4fI3v5iawCanUsmVs5NPN3y-3O3AWRl8xlUKsDTEQPzR0tQK9NbVRD0sITQV-67ffNfuiLbuZ6E-iKmYU8s3mZXJWZHr_kl-e2UVaU7hjmuuxtJjertubJLQ-TXT80uMwrUyH";
